 ...
 * @Description: 倒计时类
 * @Author: xianggu
 * @CreateDate: 2019/1/15 2:43 PM
 */
public class CountDownTimerUtil extends CountDownTimer {

    private TextView remainingTv;

    public CountDownTimerUtil(long millisInFuture, long countDownInterval, TextView remainingTv) {
    ...
    public CountDownTimerUtil(TextView remainingTv) {
